...
use crate::backend::{
    get_chemv_for_lp64_cblas, get_chemv_for_ilp64_cblas, ChemvProvider,
    get_dsymv_for_lp64_cblas, get_dsymv_for_ilp64_cblas, DsymvProvider,
    get_ssymv_for_lp64_cblas, get_ssymv_for_ilp64_cblas, SsymvProvider,
    get_zhemv_for_lp64_cblas, get_zhemv_for_ilp64_cblas, ZhemvProvider,
};
use crate::types::{
...
pub unsafe extern "C" fn cblas_ssymv(
    ...
    match order {
        ...
        SsymvProvider::Ilp64(ssymv) => {
            let n = n as i64; let lda = lda as i64; let incx = incx as i64; let incy = incy as i64;
...
pub unsafe extern "C" fn cblas_ssymv_64(
    ...
    match order {
        ...
        SsymvProvider::Lp64(ssymv) => {
            let n = n as i32; let lda = lda as i32; let incx = incx as i32; let incy = incy as i32;
