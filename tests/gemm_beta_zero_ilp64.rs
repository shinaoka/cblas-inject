...
use cblas_inject::{
    cblas_cgemm_64, cblas_dgemm_64, cblas_inject_register_cgemm_ilp64,
    cblas_inject_register_dgemm_ilp64, cblas_inject_register_sgemm_ilp64,
    cblas_inject_register_zgemm_ilp64, cblas_sgemm_64, cblas_zgemm_64, CblasColMajor, CblasNoTrans,
    CblasRowMajor,
};
...
fn all_gemm_families_preserve_beta_contract_in_both_orders() {
    unsafe {
        assert_eq!(
            cblas_inject_register_sgemm_ilp64(sgemm_contract as *const _),
            0
        );
        assert_eq!(
            cblas_inject_register_dgemm_ilp64(dgemm_contract as *const _),
            0
        );
        assert_eq!(
            cblas_inject_register_cgemm_ilp64(cgemm_contract as *const _),
            0
        );
        assert_eq!(
            cblas_inject_register_zgemm_ilp64(zgemm_contract as *const _),
            0
        );
